...
<div class="main-container">
    <div class="curriculum-content" >
		<div class="main_text">
			...
			<div>
				<div id="memberpic" style="display: inline"><strong class="style8">[19대 학생회 사진] &nbsp;&nbsp;&nbsp;</strong></div>
				<div id="memberchart" style="display: inline"><strong class="style9">[19대 학생회 조직도]</strong></div>
			</div>
			<br>
			<div class="ur_img"><img id="sysimg" src="img/schoolmember.jpg" width="690" height="auto" alt="이수체계도"></div>
		</div>
    </div>
    <?Side::render('members');?>
</div>
