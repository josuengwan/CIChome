	...
	public static function render(){
		...
		echo '<div class="header">
			    <div class="high-top-nav-bar">
			        <div class="high-top-nav-item"><a href="'.TEMPLATES_PATH.'/contact/contact">CONTACT</a></div>';
			        ...
			        <ul id="navbar">
			            <li><a href="'.TEMPLATES_PATH.'/introduce/greeting">학과소개</a>
			                <ul>
			                    ...
			                    <li><a href="'.TEMPLATES_PATH.'/introduce/history">학과역사</a></li>
			            ...
			            <li><a href="#">대학원</a>
			                <ul>
			                    <li><a target="_blank" href="http://signal.hongik.ac.kr">통신 신호처리 실험실</a></li>
			                    <li><a target="_blank" href="http://unclab.hongik.ac.kr">유비쿼터스 네트워크/컨버전스</a></li>
			                    <li><a target="_blank" href="http://selab.hongik.ac.kr">소프트웨어공학 실험실</a></li>
			                    ...
			                    <li><a target="_blank" href="http://nsl.hongik.ac.kr/">네트워크시스템 연구실</a></li>
			                </ul>
			            </li>
			        </ul>
			    </div>
