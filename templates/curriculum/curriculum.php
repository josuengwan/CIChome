...
<div class="main-container">
    ...
    <div class="main_text">
	  ...
	  <table width="670" border="0" cellspacing="0" cellpadding="0" summary="교과과정테이블" style="margin-bottom:20px">
        ...
        <tr>
          <td height="20">역사와 철학(3영역) 동양문화사</td>
		  <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
		  <td align="center">002013</td>
          <td align="center">3</td>
          <td align="center">3</td>
        </tr>
        <tr>
          <td colspan="2" rowspan="1" align="center">핵교양</td>
        ...
        <tr>
          <td height="20">일반화학</td>
          <td align="center">730833</td>
          <td align="center">3</td>
          <td align="center">3</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
        ...
        <tr>
          <td height="20">C-프로그래밍 및 실습</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">010810</td>
          <td align="center">3</td>
          <td align="center">3</td>
        </tr>
        <tr>
 ...
 ※「교과과정 개편에 따른 졸업학점 현황」의 MSC 교과과정 이수요건을 반드시 확인하여야 함.<br>
※ 기본소양 권장교과목 : 사회와경제(경제학입문), 역사와문화(동양사의이해), 공학의이해(컴퓨터정보통신공학개론)<br>
※ 2009학년도 입학생부터 컴퓨터정보통신공학 심화프로그램 전공자가 공학컴퓨터입문 및 실습, C-프로그래밍 및 실습을 이수하면 그 과목은 전공선택으로 인정됨<br></p>
      ...
      <table width="670" border="0" cellspacing="0" cellpadding="0" summary="교과과정테이블" style="margin-bottom:20px">
        ...
        <tr>
          <th height="30" colspan="2" align="center">기초<br>소양</th>
		  ...
		  <font style="font-size:11px">▶  자료구조 및 프로그래밍</font><br>
		  <font style="font-size:11px">→ 자료구조 및 프로그래밍 실습<p></p></font> 
		  <font style="font-size:11px">▶ 객체지향프로그래밍</font><br>
		  <font style="font-size:11px">→ 객체지향프로그래밍 및 실습</font><br><br>
		  </td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="20">전자회로</td>
          <td align="center">704513</td>
          <td align="center">3</td>
          <td align="center">3</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
        ...
        <tr>
          <td height="20">인터넷공학</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">704408</td>
          <td align="center">3</td>
          <td align="center">3</td>
        </tr>
        <tr>
          <td height="20">객체지향프로그래밍 및 실습</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">704409</td>
          <td align="center">3</td>
          <td align="center">4</td>
        </tr>
        <tr>
...
※ 컴과학기술대학 공통 전공선택 권장교과목 : *창의적공학설계입문<br>
※ 기본소양 권장교과목 : 예술과 생활(현대생활과 디자인)<br>
※ 2009학년도 입학생부터 컴퓨터정보통신공학심화프로그램 전공자가 웹프로그래밍을 수강하면 그 과목은 전공선택으로 인정됨<br></p>
      ...
      <p class="font13 mr20 bold style9">3학년</p>
       ...
       <tbody><tr>
        ...
        <tr>
          <th width="30" height="30" colspan="2" rowspan="2" align="center">기초<br>소양</th>
          <td width="30" rowspan="2" align="center">핵심<br>교양</td>
          <td height="30">언어와논리(1영역)<br>교양한문(1) </td>
        ...
        <tr>
          <td height="20">의사소통(8영역) <br>기술문서작성법</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">004182</td>
          <td align="center">3</td>
          <td align="center">3</td>
        </tr>
        <tr>
        ...
        <tr>
          <th colspan="3" rowspan="1" scope="row">
            <p align="center">전공필</p></th>
          <td height="20">알고리즘 및 실습</td>
          <td align="center">704704</td>
          <td align="center">4</td>
          <td align="center">4</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
        ...
        <tr>
          <td height="20">객체지향설계 및 실습</td>
          <td align="center">704821</td>
          <td align="center">3</td>
          <td align="center">4</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
        ...
        <tr>
          <td height="20">컴퓨터네트워크</td>
          <td align="center">704803</td>
          <td align="center">3</td>
          <td align="center">3</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
        ...
        <tr>
          <td height="20">디지털기술 융합</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">704610</td>
          <td align="center">2</td>
          <td align="center">2</td>
        </tr>
		<tr>
...
※ 기본소양 권장교과목 : 언어와논리(교양한문(1)), 의사소통(공학의사소통)<br>
      ...
      <p class="font13 mr20 bold style9">4학년</p>
        ...
        <tr>
          <th align="center">기초<br>소양</th>
          <th align="center">일반<br>교양</th>
		...
		<tr>
          ...
          <td align="center">-</td>
          <td align="center">-</td>
		  <td align="center">704815</td>
          <td align="center">3</td>
          <td align="center">3</td>
        </tr>
		<tr>
          <td height="20">네트워크 프로그래밍 및 실습</td>
          <td align="center">&nbsp;</td>
          <td align="center">-</td>
          <td align="center">-</td>
          <td align="center">704810</td>
          <td align="center">3</td>
          <td align="center">4</td>
        </tr>
        <tr>
